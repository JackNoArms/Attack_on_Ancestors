...
class Bestiario:
    def __init__(self, nome, genero, raca, classe, level, estado, vida_t, vida_a, mana_t, mana_a, vigor_t, vigor_a, dano_fisico, dano_especial, defesa, defesa_especial, chance_esquiva, forca, destreza, constituicao, carisma, inteligencia, cod_reino, cod_cidade, cod_localidade):
